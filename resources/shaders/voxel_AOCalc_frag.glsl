...
void main()
{
    vec4 blockColor_withAmbient = vec4(block_color.xyz * fAmbientOcclusion, block_color.w);
    ...
    vec3 diffusionLight = blockColor_withAmbient.xyz * clamp(dot(N, L), 0.0, 1.0);
    ...
    color = vec4(lightColor, blockColor_withAmbient.w);
}
